...
export const EditQuestionPortal = () => {
  ...
  return (
    ...
    >
      {alertState.status && (
        <AlertPopUp message={alertState.message} state={alertState.state} />
      )}
            ...
            <CardBody>
              {allQuestions &&
                allQuestions.map((el, key) => {
                  return (
                    <div className="p-5 flex border-1 border-solid border-blue-50">
                      <span
          ...
          <div>
            <div className="grid grid-cols-2 gap-5">
              ...
              <Input
                ...
                onValueChange={(value) =>
                  handlePayloadChange("question", value)
                }
              />
              ...
              <Input
                ...
                type="text"
                label="Please enter Option A"
                placeholder="Please enter Options"
                onValueChange={(value) => handlePayloadChange("optionA", value)}
              />

              <Input
                value={values.optionB}
                type="text"
                label="Please enter Option B"
                placeholder="Please enter Question"
                onValueChange={(value) => handlePayloadChange("optionB", value)}
              />

              <Input
                value={values.optionC}
                type="text"
                label="Please enter Option C"
                placeholder="Please enter Question"
                onValueChange={(value) => handlePayloadChange("optionC", value)}
              />

              <Input
                value={values.optionD}
                type="text"
                label="Please enter Option D"
                placeholder="Please enter Question"
                onValueChange={(value) => handlePayloadChange("optionD", value)}
              />

              <Input
                value={values.answer}
                type="text"
                label="Please enter Answers"
                placeholder="Please enter Answers"
                onValueChange={(value) => handlePayloadChange("answer", value)}
              />
              ...
              <Input
                ...
                onValueChange={(value) => handlePayloadChange("credits", value)}
              />
            </div>
            <div>
              <Button onClick={handleSubmit} color="primary" className="w-full mt-4">
                Submit
              </Button>
            </div>
          </div>
