                ...
                <Card className="max-w-[90%] mx-auto sticky top-20">
                    ...
                    <CardBody>
                        <div className="flex flex-col text-lg font-serif my-4p">
                            <span className="my-1p"> Questions Attempt : <span className="font-semibold">123</span></span>
                            <span className="my-1p"> Correct Attempt : <span className="font-semibold">0</span></span>
                            <span className="my-1p"> Wrong Attempt : <span className="font-semibold">1</span></span>
                            <span className="my-1p"> Total Marks : <span className="font-semibold">21</span></span>
                            <span className="my-1p"> Grade : <span className="font-semibold">Pass</span></span>
                        </div>
                    </CardBody>
                </Card>
